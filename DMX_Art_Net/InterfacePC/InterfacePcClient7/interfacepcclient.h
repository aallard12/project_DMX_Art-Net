...
private slots:
    ...
    void onAnalyseClaudeTerminee(const QJsonObject& equipementJson);
    void onErreurClaude(const QString& message);
...
private:
    ...
    void remplirFormulaireDepuisJson(const QJsonObject& equipementJson);
};
