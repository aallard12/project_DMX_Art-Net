...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 09 avr. 2026 à 06:12
...
--
ALTER TABLE `CANAUX`
  MODIFY `idCanal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=151;

--
-- AUTO_INCREMENT pour la table `EQUIPEMENTS`
--
ALTER TABLE `EQUIPEMENTS`
  MODIFY `idEquipement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `FONCTIONNALITE_CANAL`
--
ALTER TABLE `FONCTIONNALITE_CANAL`
  MODIFY `idFonctionnalite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=330;

--
-- AUTO_INCREMENT pour la table `SCENES`
--
ALTER TABLE `SCENES`
  MODIFY `idScene` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT pour la table `UNIVERS`
--
ALTER TABLE `UNIVERS`
  MODIFY `idUnivers` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
