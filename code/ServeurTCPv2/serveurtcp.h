...
/**
 * @class ServeurTcp
 * @brief Serveur de gestion DMX/Art-Net, API JSON et authentification.
 */
...
private:
    ...
    /**
     * @brief Vérifie les identifiants dans la base de données de manière sécurisée (SHA-256).
     * @param client Socket TCP du client.
     * @param user Nom d'utilisateur tapé.
     * @param mdp Mot de passe tapé (sera haché en interne).
     */
    void verifierLogin(QTcpSocket *client, const QString &user, const QString &mdp);
